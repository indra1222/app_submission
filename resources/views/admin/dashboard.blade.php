          ...
          <a href="{{ route('admin.surat-keluar') }}" class="text-decoration-none">
              <div class="card bg-primary text-white h-100">
                  <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center">
                          <div>
                              <h6 class="mb-0">Surat Keluar (Form 1)</h6>
                              <h2 class="mb-0">{{ $stats['surat_keluar'] }}</h2>
                          </div>
          ...
          <a href="{{ route('admin.surat-masuk') }}" class="text-decoration-none">
              <div class="card bg-success text-white h-100">
                  <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center">
                          <div>
                              <h6 class="mb-0">Surat Masuk (Form 2 & 3)</h6>
                              <h2 class="mb-0">{{ $stats['surat_masuk'] }}</h2>
                          </div>
