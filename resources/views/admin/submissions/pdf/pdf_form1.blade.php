...
<head>
   ...
   <style>
       ...
       .kepada-section .content {
        margin-left: -20px;  /* Sesuaikan margin untuk konten Kepada */
    }
       .row {
           position: relative;
           padding-left: 130px;
       ...
       .section {
        margin-bottom: 3px; /* Kurangi margin bottom */
    }
       .data-pegawai {
           margin-bottom: 5px;
           position: relative;
       ...
       .data-label {
        ...
        width: 80px;
        margin-left: 20px;  /* Berikan margin untuk label data */
    }
    .data-colon {
        display: inline-block;
        width: 15px;
    ...
    .ttd {
   margin-top: 20px;         /* Naikkan margin top dari 12px ke 20px */
   position: relative;
   float: right; 
   width: 270px;
   margin-right: -20px;        /* Kurangi margin kanan dari 10px ke 0px untuk geser ke kanan */
   padding-right: 0;         /* Pastikan tidak ada padding yang mengganggu */
}
    .ttd p {
        margin: 2px 0;      /* Ubah margin ke lebih spesifik */
        line-height: 1.1;
        padding-right: 100px; /* Tambah padding kanan untuk geser teks */
    }
    .ttd .jabatan {
        text-align: center;
        margin-bottom: 50px;
    ...
    .ttd .nip {
    text-align: center;
    letter-spacing: -0.8px;  /* Kurangi sedikit jarak antar huruf jika perlu */
}
    .clear {
        clear: both;     /* Tambahkan clear untuk menghindari overlap */
        height: 10px;    /* Berikan sedikit ruang */
    }
   ...
   font-size: 8pt;
   line-height: 1.2;
   margin-top: 75px;  /* Naikkan margin top dari 35px ke 55px */
   width: 100%;
}
.footer p {
   margin: 0;
...
<div class="footer">
    ...
    <p class="kontak">Telp.: (0262) 233273 Fax: (0262) 4893051 e-mail: <a href="mailto:bps3205@bps.go.id">bps3205@bps.go.id</a> homepage: garutkab.bps</p>
</div>
   </div>
</body>
</html>